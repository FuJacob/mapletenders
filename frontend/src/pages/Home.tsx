    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-surface border-b border-border p-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <Link to="/test" className="text-2xl font-bold text-primary">
            Procuroo
          </Link>
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-surface border border-border rounded-xl p-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm text-success font-medium">+{mockStats.newTenders}</span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* Search Section */}
            <div className="bg-surface border border-border rounded-xl p-6">
              <h2 className="text-xl font-semibold text-text mb-4">Find Opportunities</h2>
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 border border-border rounded-xl bg-background focus:border-primary focus:outline-none text-lg"
                />
              </div>
              <div className="flex gap-2 mb-4">
                ...
                <button className="border border-border px-4 py-2 rounded-lg text-text-light hover:text-text hover:bg-border transition-colors">
                  <Funnel className="w-4 h-4" />
                </button>
              </div>
              <div>
                <p className="text-sm text-text-light mb-2">Try these examples:</p>
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-text-light mb-2">{tender.organization}</p>
            ...
            <div className="bg-surface border border-border rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
                  <p className="text-sm font-medium text-red-800">Software Development RFP</p>
                  <p className="text-xs text-red-600">Due in 2 days</p>
                </div>
                <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p className="text-sm font-medium text-yellow-800">IT Consulting Services</p>
