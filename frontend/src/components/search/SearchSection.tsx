        ...
        <div className="flex flex-wrap gap-1">
          {exampleSearches.map((example, index) => (
            <button
              ...
              className="text-xs bg-surface border border-border text-text-light px-3 py-1 rounded-xl hover:bg-primary hover:text-white hover:border-primary transition-all duration-200 shadow-sm hover:shadow-md"
            >
              {example}
            </button>
          ))}
